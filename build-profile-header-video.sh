...
github_mp4="${here}/assets/profile-header.mp4"
github_gif="${here}/assets/profile-header.gif"
linkedin_cover="${here}/assets/profile-header-linkedin-cover.jpg"
...
cd "$render_dir"
echo "==> Rendering Header 30s loop at 3840x960..."
node render.js
...
echo "==> Extracting HD LinkedIn Banner..."
ffmpeg -v error -y -ss 12 -i "$github_mp4" -vframes 1 -q:v 2 "$linkedin_cover"
